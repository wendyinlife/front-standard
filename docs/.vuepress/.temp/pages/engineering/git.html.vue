...
<h2 id="_1-git-提交日志格式规约" tabindex="-1"><a class="header-anchor" href="#_1-git-提交日志格式规约"><span>1. Git 提交日志格式规约</span></a></h2>
<h3 id="_1-1-前言" tabindex="-1"><a class="header-anchor" href="#_1-1-前言"><span>1.1. 前言</span></a></h3>
<p>为什么要对 <code v-pre>Git</code> 提交日志（<code v-pre>message</code>）的格式进行规约约束？</p>
<ol>
...
<span class="line">3. 标点方面遵循一般的文档格式规约。</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-git-分支命名规约" tabindex="-1"><a class="header-anchor" href="#_2-git-分支命名规约"><span>2. Git 分支命名规约</span></a></h2>
...
<blockquote>
<p>注：该命名规约只针对新建的临时分支，不包括如 master、develop 等常驻分支</p>
</blockquote>
...
<p>其他开发过程中的分支命名参考上节 2.2 的分支命名规约。</p>
<h2 id="_3-git-tag-命名规约" tabindex="-1"><a class="header-anchor" href="#_3-git-tag-命名规约"><span>3. Git tag 命名规约</span></a></h2>
...
<li><a href="http://karma-runner.github.io/0.13/dev/git-commit-msg.html" target="_blank" rel="noopener noreferrer">Karma 的 Git 日志规约</a></li>
